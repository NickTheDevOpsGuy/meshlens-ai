...
export function correlateIncidents(incidents: IncidentBundle[]): IncidentBundle[][] {
...
export function groupByService(incidents: IncidentBundle[]): Map<string, IncidentBundle[]> {
